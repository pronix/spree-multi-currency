...
desc 'Generate documentation for the multi_currency extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'MultiCurrencyExtension'
...
desc 'Test the multi_currency extension.'
...
namespace :test do
  desc 'Functional test the multi_currency extension.'
  ...
  desc 'Unit test the multi_currency extension.'
